...
public:
	...
	static FileOpLock* CreateLock(const std::wstring& name, FileOpLock::UserCallback cb, HANDLE p_provided = INVALID_HANDLE_VALUE);
...
private:
	...
	bool BeginLock(const std::wstring& name, HANDLE p_provided = INVALID_HANDLE_VALUE);
