...
if __name__ == '__main__':
	...
	Runner contains second download cradle to retrieve AES-256 key to decrypt shellcode.
	...
	Successfully injected processes:
		...
		High: spoolsv, dwm, svchost, winlogon	WARNING: svchost in high integrity may crash the target but has been shown to work. Also note Spoolsv may not have the same permissions as other system processes.
	'''))
